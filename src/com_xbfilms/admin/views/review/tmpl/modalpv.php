...
<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true" 
     ...
     <h4 class="modal-title">Preview Film Review</h4>
</div>
<div class="modal-body">
    <div style="margin:0 30px;">
		<iframe src="<?php echo JURI::root(); 
            ?>/index.php?option=com_xbfilms&view=filmreview&layout=default&tmpl=component&id=
	       <?php echo JFactory::getApplication()->input->getInt('id'); ?>" 
			title="Preview Film Review" id="pv" class="iframe-full-height"></iframe>   
	</div>
</div>
