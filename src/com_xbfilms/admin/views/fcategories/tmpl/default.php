...
$bvlink = 'index.php?option=com_xbfilms&view=films&catid=';
$rvlink = 'index.php?option=com_xbfilms&view=reviews&catid=';
$pvlink = 'index.php?option=com_xbfilms&view=persons&catid=';
$pplink = 'index.php?option=com_xbpeople&view=persons&catid=';
$chvlink = 'index.php?option=com_xbfilms&view=characters&catid=';
$chplink = 'index.php?option=com_xbpeople&view=characters&catid=';

$prevext ='';

?>
<form action="index.php?option=com_xbfilms&view=fcategories" method="post" id="adminForm" name="adminForm">
