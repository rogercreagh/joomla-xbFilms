...
class XbfilmsViewFilmreviews extends JViewLegacy {
    ...
    function display($tpl = null) {
        ...
        $params = $this->state->get('params'); //ComponentHelper::getParams('com_xbfilms');
        ...
        $this->show_pic = $params->get('show_rpiccol','1','int');
